...
@Component({
  selector: 'app-aforgotpassword',
  templateUrl: './aforgotpassword.component.html',
  styleUrls: ['./aforgotpassword.component.css']
})
export class AforgotpasswordComponent implements OnInit {
